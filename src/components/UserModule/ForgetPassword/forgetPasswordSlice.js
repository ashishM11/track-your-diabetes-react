...
export const authenticate = createAsyncThunk('users/authenticate', async (userRequestDTO) => {
    const response = await axios.post('http://localhost:9000/api/v1/user/auth',userRequestDTO);
